...
import DefinitelyNotReddit from "./Projects/DefinitelyNotReddit";
import MelodyChuangCoaching from "./Projects/MelodyChuangCoaching";
...
const Projects = () => {
	return (
		<div id="projects" className="pt-24 pb-16 lg:pb-32 lg:pt-24">
			<SectionHeader number="2" title="what i've made" emoji="💡" />
			<div className="mt-10 space-y-20 lg:space-y-32 lg:mt-16 md:ml-20 lg:ml-10 md:mr-2">
				<DefinitelyNotReddit />
